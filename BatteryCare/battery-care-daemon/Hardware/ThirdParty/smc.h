...
/// Force-write a single byte to an SMC key, bypassing the dataSize pre-check.
/// Use when SMCGetKeyInfo returns 0 for dataSize but the key may still accept writes.
